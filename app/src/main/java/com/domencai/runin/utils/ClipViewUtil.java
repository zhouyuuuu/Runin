...
public class ClipViewUtil extends View {
    ...
    public ClipViewUtil(Context context) {
        this(context, null);
    }

    public ClipViewUtil(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClipViewUtil(Context context, AttributeSet attrs, int defStyle) {
